...
public class C2SMouseClickConditionPacket {
    private final String key;
    private final boolean value;;

    public C2SMouseClickConditionPacket(String key, boolean value) {
        this.key = key;
        this.value = value;
    }

    public C2SMouseClickConditionPacket(FriendlyByteBuf buffer) {
