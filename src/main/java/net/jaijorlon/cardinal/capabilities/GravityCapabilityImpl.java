...
import net.jaijorlon.cardinal.mob_effect.GravityDirectionMobEffect;
import net.jaijorlon.cardinal.network.GravityNetwork;
import net.jaijorlon.cardinal.network.UpdateGravityCapabilityPacket;
import net.jaijorlon.cardinal.network.UpdateGravitySyncStatePacket;
        ...
        if (vehicle != null) {
            ...
            try {
                ...
                if (entity instanceof LivingEntity living) {
                    if (living.hasEffect(CardinalMobEffects.INVERT.get())) {
                        this.applyGravityDirectionEffect(
                ...
                if (entity instanceof LivingEntity living) {
                	CardinalMobEffects.INCREASE.get().apply(living, this);
                    CardinalMobEffects.DECREASE.get().apply(living, this);
                    CardinalMobEffects.REVERSE.get().apply(living, this);
                }
