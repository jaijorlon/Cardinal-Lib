...
public class CardinalConditionSerializers {
    ...
    public static final RegistrySupplier<ConditionSerializer> IS_PASSENGER = CONDITION_SERIALIZERS.register("is_passenger", IsPassengerCondition.Serializer::new);
    ...
    public static final RegistrySupplier<ConditionSerializer> MOVING_TOWARDS_AXIS = CONDITION_SERIALIZERS.register("moving_towards_axis", MovingTowardsAxisCondition.Serializer::new);
}
