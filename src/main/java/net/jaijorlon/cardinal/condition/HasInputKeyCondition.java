...
public class HasInputKeyCondition extends Condition {
    ...
    public boolean active(DataContext context) {
        ...
        if (entity != null) {
            if (entity.getPersistentData().getBoolean("Cardinal.HasInputKeyCondition.up")) {
                if (Arrays.stream(this.inputKeys).anyMatch(s -> s.equalsIgnoreCase("forward") || s.equalsIgnoreCase("up"))) {
                    return true;
                }
            }
            if (entity.getPersistentData().getBoolean("Cardinal.HasInputKeyCondition.down")) {
                if (Arrays.stream(this.inputKeys).anyMatch(s -> s.equalsIgnoreCase("down") || s.equalsIgnoreCase("backward"))) {
                    return true;
                }
            }
            if (entity.getPersistentData().getBoolean("Cardinal.HasInputKeyCondition.left")) {
                if (Arrays.stream(this.inputKeys).anyMatch(s -> s.equalsIgnoreCase("left"))) {
                    return true;
                }
            }
            if (entity.getPersistentData().getBoolean("Cardinal.HasInputKeyCondition.right")) {
            ...
            if (entity.getPersistentData().getBoolean("Cardinal.HasInputKeyCondition.sprint")) {
                if (Arrays.stream(this.inputKeys).anyMatch(s -> s.equalsIgnoreCase("sprint"))) {
                    return true;
                }
            }
            if (entity.getPersistentData().getBoolean("Cardinal.HasInputKeyCondition.use")) {
                if (Arrays.stream(this.inputKeys).anyMatch(s -> s.equalsIgnoreCase("use"))) {
                    return true;
                }
            }
            if (entity.getPersistentData().getBoolean("Cardinal.HasInputKeyCondition.attack")) {
                if (Arrays.stream(this.inputKeys).anyMatch(s -> s.equalsIgnoreCase("attack"))) {
                    return true;
                }
            }
            if (entity.getPersistentData().getBoolean("Cardinal.HasInputKeyCondition.shift")) {
                if (Arrays.stream(this.inputKeys).anyMatch(s -> s.equalsIgnoreCase("shift"))) {
                    return true;
                }
            }
            if (entity.getPersistentData().getBoolean("Cardinal.HasInputKeyCondition.advancements")) {
                if (Arrays.stream(this.inputKeys).anyMatch(s -> s.equalsIgnoreCase("advancements"))) {
                    return true;
                }
            }
            if (entity.getPersistentData().getBoolean("Cardinal.HasInputKeyCondition.chat")) {
                if (Arrays.stream(this.inputKeys).anyMatch(s -> s.equalsIgnoreCase("chat"))) {
                    return true;
                }
            }
            if (entity.getPersistentData().getBoolean("Cardinal.HasInputKeyCondition.command")) {
            ...
            if (entity.getPersistentData().getBoolean("Cardinal.HasInputKeyCondition.fullscreen")) {
                if (Arrays.stream(this.inputKeys).anyMatch(s -> s.equalsIgnoreCase("fullscreen"))) {
                    return true;
                }
            }
            if (entity.getPersistentData().getBoolean("Cardinal.HasInputKeyCondition.inventory")) {
                if (Arrays.stream(this.inputKeys).anyMatch(s -> s.equalsIgnoreCase("inventory"))) {
                    return true;
                }
            }
            if (entity.getPersistentData().getBoolean("Cardinal.HasInputKeyCondition.pick_item")) {
                if (Arrays.stream(this.inputKeys).anyMatch(s -> s.equalsIgnoreCase("pick_item"))) {
                    return true;
                }
            }
            if (entity.getPersistentData().getBoolean("Cardinal.HasInputKeyCondition.swap_offhand")) {
                if (Arrays.stream(this.inputKeys).anyMatch(s -> s.equalsIgnoreCase("swap_offhand"))) {
                    return true;
                }
            }
            if (entity.getPersistentData().getBoolean("Cardinal.HasInputKeyCondition.toggle_perspective")) {
                if (Arrays.stream(this.inputKeys).anyMatch(s -> s.equalsIgnoreCase("toggle_perspective"))) {
                    return true;
                }
            }
            if (entity.getPersistentData().getBoolean("Cardinal.HasInputKeyCondition.smooth_camera")) {
